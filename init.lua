...
for i in ipairs(beds_list) do
	...
	minetest.register_node("decorative_beds:bed_bottom_"..colour, {
		description = beddesc,
		drawtype = "nodebox",
		...
		after_place_node = function(pos, placer, itemstack)
			...
			node.name = "decorative_beds:bed_top_"..colour
			if param2 == 0 then
				pos.z = pos.z+1
		...
		on_destruct = function(pos)
			...
			if( minetest.env:get_node({x=pos.x, y=pos.y, z=pos.z}).name == "decorative_beds:bed_top_"..colour ) then
	...
	minetest.register_node("decorative_beds:bed_top_"..colour, {
		drawtype = "nodebox",
	...
	minetest.register_alias("decorative_beds:bed_"..colour, "decorative_beds:bed_bottom_"..colour)
	
	minetest.register_craft({
		output = "decorative_beds:bed_"..colour,
		recipe = {
...
minetest.register_alias("decorative_beds:bed_bottom", "decorative_beds:bed_bottom_blue")
